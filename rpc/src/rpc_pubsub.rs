...
use crate::rpc_subscription_tracker::SignatureSubscriptionType;
#[cfg(test)]
...
pub trait RpcSolPubSub {
    ...
    // Get Notification When Xandeum Signature is verified
    #[pubsub(
        subscription = "xandeumResultNotification",
        subscribe,
        name = "xandeumResultSubscribe"
    )]
    fn xandeum_result_subscribe(
        &self,
        meta: Self::Metadata,
        subscriber: Subscriber<RpcResponse<RpcSignatureResult>>,
        signature_str: String,
        config: Option<RpcXandeumResultSubscribeConfig>,
    );
...
use solana_client::rpc_config::RpcXandeumResultSubscribeConfig;
...
mod internal {
    ...
    pub trait RpcSolPubSubInternal {
        ...
        // Get notification when signature is verified
        // Accepts signature parameter as base-58 encoded string
        #[rpc(name = "xandeumResultSubscribe")]
        fn xandeum_result_subscribe(
            &self,
            signature_str: String,
            config: Option<RpcXandeumResultSubscribeConfig>,
...
impl RpcSolPubSubInternal for RpcSolPubSubImpl {
    ...
    fn xandeum_result_subscribe(
        ...
        let params = SignatureSubscriptionParams {
            ...
            subscription_type: SignatureSubscriptionType::XandeumResult,
        };
        self.subscribe(SubscriptionParams::Signature(params))
    }
